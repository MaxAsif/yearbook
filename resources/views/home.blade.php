...
<body>
  <div class="container-fluid">
    ...
    <div>
      <!--
        This prints the flashed message from file controller if upload was 
        succesful or not.
      -->
      @if(session('message'))
      ...
      <div id="modal1" class="modal">
        <div class="modal-content center">
          <form action="/upload_pic_moto" method="post" enctype="multipart/form-data">
            ...
            <img src="<?php if (!empty(Auth::user()->pro_pic)){echo Auth::user()->pro_pic; } else { echo 'ind/shot.jpg';}?>" alt="" class="circle responsive-img" id="OpenImgUpload" style="cursor: pointer;width: 180px;height: 180px;">
            <div class="input-field col s12 l12 m12">
              <label for="motto">Caption (Max 50 characters)</label>
              <textarea name="motto" id="icon_prefix2" required class="materialize-textarea" placeholder="Enter Your Caption Here (Max 50 characters)" style="text-align: center;color: black;" maxlength="50"><?php if (!empty(Auth::user()->view_self)) { echo Auth::user()->view_self;}else {echo 'Enter Your Caption Here';}?>
              </textarea>
            </div>
      ...
      <button id="btnn1" class="waves-effect waves-light btn" style="float: right;width: 150px;padding: 0 ;margin-right: 20px;" onclick="javascript:introJs().start();">
        Tutorial
      ...
      <div class="container">
        <button class="modal-trigger waves-effect waves-light btn col l5 m12 s12" href="#modal1" style=" padding-top: 0;padding-left: 25px;padding-right: 25px;">
          Upload Profile Picture and Caption
        </button>
        <div align="center" class="row">
          <div class="">
            <a class="modal-trigger" href="#modal1">
              <img src="<?php if (!empty(Auth::user()->pro_pic)){echo Auth::user()->pro_pic; } else { echo 'ind/your.jpg';}?>" class="circle" width="200px" height="200px" data-step="1" data-intro="Click on image to Upload Profile pic and Caption"> 
            </a>
          </div>
          <h4> 
