            ...
            <script type="text/javascript">
              ...
              <div class="input-field col s12 l12 m12">
                ...
                <textarea name="motto" id="icon_prefix2" required class="materialize-textarea" placeholder="Enter Your Caption Here (Max 50 characters)" style="text-align: center;color: black;" maxlength="50">
                  <?php if (!empty(Auth::user()->view_self)) { echo Auth::user()->view_self;}else {echo 'Enter Your Caption Here';}?>
          ...
          <div class="container">
            ...
            <div align="center" class="row">
              <div class=""><a class="modal-trigger" href="#modal1">
                <img src="<?php if (!empty(Auth::user()->pro_pic)){echo Auth::user()->pro_pic; } else { echo 'ind/your.jpg';}?>" class="circle" width="200px" height="200px" data-step="1" data-intro="Click on image to Upload Profile pic and Caption"> </a>
              </div>
              <h4> <?php echo Auth::user()->name;  ?> </h4>
              <h5>"
                <?php 
                if (!empty(Auth::user()->view_self)) { echo Auth::user()->view_self;}
                  else{
